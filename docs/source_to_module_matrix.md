...
|---|---|---|---|---|---|---|
| Market Overview | Fasecolda - Ciudades y Ramos | None | `gross_written_premium`, `claims`, `year`, `company_standard`, `line_of_business_standard`, `city` | Premium totals, claims totals, loss ratio, market share, premium growth | Uses static demo snapshot; annual views use latest cut per year | High for internal market intelligence |
| Company Explorer | Fasecolda - Ciudades y Ramos | None | Company, premiums, claims, year, line | Company premium trend, claims trend, loss ratio, top lines | Depends on selected filters and standard company naming | High for internal market intelligence |
| Line of Business Explorer | Fasecolda - Ciudades y Ramos | None | Line, company, premiums, claims, year | Line trend, company ranking, loss ratio by company | Source line definitions should be reviewed for formal use | High for internal market intelligence |
| Company Brief | Fasecolda - Ciudades y Ramos | Indicadores de Gestion 2025 where mapped | Company, line, premium, claims, market premium, reinsurance fields | Executive summary, premium evolution, market share, alerts, questions | Reinsurance indicators are exploratory and depend on mapping availability | Medium |
| Technical Signals | Fasecolda - Ciudades y Ramos | Indicadores de Gestion 2025 | Premiums, claims, growth, market share, cession ratio | Growth rankings, loss ratio pressure, market share movement, cession ratio watchlist | Automated signals require broker interpretation | Medium |
...
| Data Status | DuckDB metadata and validation files | Mapping tables | Source, dates, records, source files, mappings, validation outputs | Coverage summaries, mapping counts, validation warning counts | Validation files may not exist in Streamlit Cloud because outputs are not committed | High for transparency, Medium for validation completeness |
